      ...
      body: Container(
        child: ListView(
          children: [
                ...
                child: Row(
                  ...
                  children: [
                    GestureDetector(
                      onDoubleTap: () {
                        playAudio(
                            "Hai" + user.email.replaceAll('@gmail.com', ''));
                      },
                      child: Text(
                        (user != null)
                            ? ("Hai, " +
            ...
            Container(
              margin: EdgeInsets.only(left: 20, right: 20, bottom: 0, top: 16),
              child: GestureDetector(
                onDoubleTap: () {
                  playAudio("Deteksi Gambar");
                },
                child: Text(
                  "Deteksi Gambar",
                  style: blackTextFont.copyWith(
                            ...
                            child: Column(
                              ...
                              children: [
                                Icon(MdiIcons.cameraOutline,
                                    size: 32, color: accentColor1),
                                SizedBox(
                                  height: 5,
                                ),
                                Text("Kamera", style: blackTextFont.copyWith()),
                              ],
                            ),
                          )),
                    ),
                      ...
                      child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.center,
                              children: [
                                Icon(MdiIcons.viewGalleryOutline,
                                    size: 32, color: accentColor1),
                                SizedBox(
                                  height: 5,
                                ),
                                Text("Galeri", style: blackTextFont.copyWith()),
                              ],
                            ),
                          )),
                    ),
